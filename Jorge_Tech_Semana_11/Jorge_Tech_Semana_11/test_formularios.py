...
from app import app, productos_lista, clientes_lista, proveedores_lista, facturas

CASOS = [
 ('/productos/nuevo', '/productos', productos_lista, dict(codigo='TEST01', nombre='Monitor', categoria='Pantallas', precio='25.50', stock='0'), [('nombre',''),('precio','-1'),('stock','-1'),('stock','1.5'),('precio','abc'),('precio','NaN'),('codigo','P001')]),
